            ...
            {/* Desktop Navmenu */}
              ...
              */}
              ...
              <ul className="hidden lg:flex items-center list-none text-center mr-[-22px]">
                ...
                <li className="">
                  <a href="/fees"  className="text-black text-[20px] flex items-center px-6 cursor-pointer hover:text-turquoise transition ease-in-out duration-200">Fee Estimate</a>
                </li>
                <li className="">
